		...
		<div class="container">
			<div class="row">
				<section>
					...
					<br />
					<p>
						Seguimos con la <strong> Cuarta Query</strong> de la tanda 1. <br />
						<strong>Cuantos profesores imparten clase en cada grupo.</strong>
					</p>
					<%
						String query5 = "SELECT G.idGrupo, COUNT(idProfesor) FROM grupos G LEFT JOIN modulos M ON (G.idGrupo = M.idGrupo) LEFT JOIN profesores P ON (M.Profesores_idProfesor = P.idProfesor) GROUP BY G.idGrupo;";
					...
					<table class="table">
						...
						<tr>
							<%
								for (int j = 0; j < tablares5[i].length; j++) {
							%>
							<td><%=tablares5[i][j]%></td>
							<%
								}
