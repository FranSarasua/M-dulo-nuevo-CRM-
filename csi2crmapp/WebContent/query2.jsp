...
<body>
	...
	<div>
		<div class="container">
			<div class="row">
				<section>
					<h2>Primera tanda de Queries.</h2>
					<br />
					<h3>Primera Query:</h3>
					<br />
					<p>
						Comenzamos nueva sección, 5 queries repartidas por la página,
						iniciamos con la <strong> primera Query</strong>. <br />
						<strong> Listado de todos los módulos y número de horas
							de clase que tiene cada uno.</strong>
					</p>
					<%
						String query = "SELECT Alias Modulo, COUNT(modulos_idModulo) Horas_Semanales FROM modulos M LEFT JOIN modulos_has_TramosHorarios H ON (M.idModulo = H.modulos_idModulo) LEFT JOIN TramosHorarios T ON (H.TramosHorarios_idTramo = T.idTramo) GROUP BY idModulo;";
