...
<body>
	...
	<div id="tf-home" class="text-center">
		<div class="overlay">
			<div class="content">
				<h1>
					Bienvenido a <strong><span class="color">BBDD</span></strong>
				</h1>
				<p class="lead">
					Una agencia con <strong> años de
						experiencia </strong> y con<br /> <strong> extraodinarios trabajadores</strong>
					.
				</p>
