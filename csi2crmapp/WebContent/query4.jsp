		...
		<div class="container">
			<div class="row">
				<section>
					...
					<br />
					<p>
						Seguimos con la <strong> Tercera Query</strong> de la tanda 1. <br />
						<strong>Número de asignaturas que hay en cada clase.</strong>
					</p>
					<%
						String query4 = "SELECT idGrupo, COUNT(idModulo) FROM modulos GROUP BY idGrupo;";
						beanDB basededatos4 = new beanDB();
						String[][] tablares4 = basededatos4.resConsultaSelectA3(query4);
					%>
					<table class="table">
						<%
						...
						<tr>
							<%
								for (int j = 0; j < tablares4[i].length; j++) {
							%>
							<td><%=tablares4[i][j]%></td>
							<%
								}
