		...
		<div class="container">
			<div class="row">
				<section>
					...
					<br />
					<p>
						Seguimos con la <strong> Segunda Query</strong> de la tanda 1. <br />
						<strong>Listado de todos los profesores y numero de
							asignaturas/modulos que imparte cada uno.</strong>
					</p>
					<%
